# [Web Application Development](https://gitlab.msu.edu/cse477-spring-2024/course-materials/): Homework 0
...
1. Navigate to the [Course Gitlab Page](https://gitlab.msu.edu/cse477-spring-2024)
...
1. Navigate to the [Course Materials Repository](https://gitlab.msu.edu/cse477-spring-2024/course-materials)
...
1. Clone a copy of the <u>course materials repository</u> to your local machine by running the following command from the terminal:
   - `git clone https://gitlab.msu.edu/cse477-spring-2024/course-materials.git`
2. Clone a copy of your <u>Personal Course Repository</u> to your local machine by running the following command from the terminal:
   - `git clone https://gitlab.msu.edu/cse477-spring-2024/<YOUR-NET-ID>.git`
...
2. From the [Course Materials Page](https://gitlab.msu.edu/cse477-spring-2024/course-materials), Click the Issues option on the left-side panel.
...
5. A [common issues post]( https://gitlab.msu.edu/cse477-spring-2024/course-materials/-/issues/2) is availble for Homework 0. Make sure to go through it before posting a new issue.

   

##### Create and Delete a Gitlab issue

1. From the [Issues Page](https://gitlab.msu.edu/cse477-spring-2024/course-materials/-/issues), create a new issue by clicking the `New issue` button in the top-right corner.
...
As part of this course, you will obtain hands-on experience publishing live web applications using Google Cloud. In most semesters, Google provides students in the class with complementary cloud credits to get you started. 

Here's how to request the credits: 

1. [Click here to request your Google Cloud coupon.](https://gcp.secure.force.com/GCPEDU?cid=UsA8ExWUWy5q3YqjtgDAKO6W%2BzqOlMv%2Bs0hb2wMMnN8x4kruDzu3myqSOcGqqdmD/)

2. When registering <u>use your @msu.edu address.</u>

3. A confirmation email will be sent to you with a coupon code.

<u>Please note:</u> the credits are available on a first-come-first-serve basis and Google often does not provide enough coupons for the entire class. If you are not able to claim a coupon this semseter, you will need to pay for cloud access on your own. Fortunately, the cloud costs tend not to be much - most students spent less than $15 over the entire semester.
...
#####  Initialize the Google Cloud SDK
 ...
 From the command line of your machine, run the command below; when prompted to provide a project name, use `cse477-spring-2024`:
...
```
 ...
 The last line in the above output is the <u>Service URL</u>; You can visit the <u>Service URL</u> above to see a live version of your web application. You can also [shut down the web app](https://console.cloud.google.com/run?project=cse477-spring-2024) from the Google Cloud Console.
...
Your assignment is not complete until you [submit the Service URL for your live web application in this Google Form](https://docs.google.com/forms/d/e/1FAIpQLScJSrWOzneYHYy1wLKTHx_QNxTDyPjFXKlcljvks72Tdi3mkw/viewform). 
